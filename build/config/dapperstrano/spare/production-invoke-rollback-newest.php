...
cd dapper$timeDrop
git show HEAD:build/config/dapperstrano/autopilots/production-node-install-code.php > /tmp/production-node-install-code.php
rm -rf /tmp/dapper$timeDrop
cd /tmp/
sudo dapperstrano autopilot execute production-node-install-code.php
sudo chown -R www-data /var/www/gcapplications/live/alca-enterprise/alca-enterprise/current/src
sudo rm production-node-install-code.php
SSHDATA;
  }
