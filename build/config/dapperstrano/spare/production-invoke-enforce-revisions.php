...
cd dapper$timeDrop
git show HEAD:build/config/dapperstrano/autopilots/production-node-install-enforce-revisions.php > /tmp/production-node-install-enforce-revisions.php
rm -rf /tmp/dapper$timeDrop
cd /tmp/
sudo dapperstrano autopilot execute production-node-install-enforce-revisions.php
sudo chown -R www-data /var/www/gcapplications/live/alca-enterprise/alca-enterprise/current/src
sudo rm production-node-install-enforce-revisions.php
SSHDATA;
  }
