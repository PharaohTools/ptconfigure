...
cd dapper$timeDrop
git show HEAD:build/config/dapperstrano/autopilots/production-node-install-code-no-dbconf.php > /tmp/production-node-install-code-no-dbconf.php
rm -rf /tmp/dapper$timeDrop
cd /tmp/
sudo dapperstrano autopilot execute production-node-install-code-no-dbconf.php
sudo chown -R www-data /var/www/gcapplications/live/alca-enterprise/alca-enterprise/current/src
sudo rm production-node-install-code-no-dbconf.php
SSHDATA;
  }
