...
class RubyRVM extends BaseLinuxApp {
  ...
  public function __construct() {
    ...
    $this->installCommands = array(
      "apt-get install libreadline6-dev libyaml-dev libsqlite3-dev sqlite3 libxml2-dev libxslt1-dev",
      "apt-get install bison libffi-dev libmysql-dev libmysql libgdbm-dev libncurses5-dev",
