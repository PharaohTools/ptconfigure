...
class AutoPilotConfigured extends AutoPilot {
        ...
        $this->steps =
            array(
                ...
                array ( "SFTP" => array( "copy" =>
                    array("original-file" => "build/config/ptconfigure/autopilots/<%tpl.php%>env_name</%tpl.php%>-cm-build-server.php" ),
    ...
    private function setSSHData() {
        $sshData = <<<"SSHDATA"
sudo ptconfigure autopilot execute /tmp/<%tpl.php%>env_name</%tpl.php%>-cm-build-server.php
SSHDATA;
        return $sshData ;
    }
