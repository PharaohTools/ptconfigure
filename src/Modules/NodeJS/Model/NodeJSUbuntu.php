...
class NodeJSUbuntu extends BaseLinuxApp {
    ...
    public function __construct($params) {
        ...
        $this->installCommands = array(
            array("method"=> array("object" => $this, "method" => "packageAdd", "params" => array("Apt", array("node", "nodejs"))) ),
        );
        $this->uninstallCommands = array(
            array("method"=> array("object" => $this, "method" => "packageRemove", "params" => array("Apt", array("node", "nodejs"))) ),
        );
