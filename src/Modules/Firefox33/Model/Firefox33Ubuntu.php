...
class Firefox33Ubuntu extends BaseLinuxApp {
  ...
  public function __construct($params) {
    ...
    $this->installCommands = array(
        array("method"=> array("object" => $this, "method" => "packageAdd", "params" => array("Apt", "libdbus-glib-1-2")) ),
        array("method"=> array("object" => $this, "method" => "packageAdd", "params" => array("Apt", "asound2")) ),
        array("method"=> array("object" => $this, "method" => "packageAdd", "params" => array("Apt", "libgtk2.0.0")) ),
        array( "command" => array(
            "cd /tmp" ,
