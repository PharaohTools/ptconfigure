...
class VultrNodeTest extends BaseVultrAllOS {
    ...
    public function askWhetherToTestNode() {
        return $this->performVultrTestNode();
    }

    public function askWhetherToTestAllEnvNodes() {
        return $this->performVultrTestAllEnvNodes();
    }

    protected function performVultrTestNode(){
        ...
        $processed = $this->getDataTestNodeFromVultr();
        return $processed ;
    }

    protected function performVultrTestAllEnvNodes(){
        if ($this->askForTestNodeExecute() != true) { return false; }
        $this->accessToken = $this->askForVultrAccessToken();
...
//        return self::askForInput($question);
    ...
    public function getDataTestNodeFromVultr(){
