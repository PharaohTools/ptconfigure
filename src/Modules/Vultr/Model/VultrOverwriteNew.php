...
class VultrOverwriteNew extends BaseVultrAllOS {
    ...
    public function askWhetherToSaveOverwriteNew($params=null) {
        return $this->performVultrOverwriteNew($params);
    }

    public function performVultrOverwriteNew($params=null){
        ...
        foreach ($environments as $environment) {
            ...
            $question = 'Overwrite current server details for '.$envName.' with new Vultr Cloud Servers?';
            ...
            if ($overwriteThisEnvironment == true) {
                ...
                foreach ($environment["servers"] as $server) {
                    ...
                    $newVultrServer = $this->getNewServerFromVultr($serverData) ;
                    $sCount++; } } }
    ...
    private function askForOverwriteExecute(){
        ...
        $question = 'Overwrite current server details with new Vultr Cloud Servers?';
