...
class VultrBoxAdd extends BaseVultrAllOS {
    ...
    public function addBox() {
        ...
        if (strlen($this->accessToken)==0) {
            ...
            $logging->log("Unable to initialize Vultr Cloud credentials.", $this->getModuleName()) ;
            return false ;
        }
            ...
            foreach ($environments as $environment) {
                if ($environment["any-app"]["gen_env_name"] == $workingEnvironment) {
                    ...
                    if (isset($this->params["yes"]) && $this->params["yes"]==true) {
                        ...
                        $question = 'Add Vultr Cloud Server Boxes to '.$envName.'?';
                    ...
                    if ($addToThisEnvironment == true) {
                        ...
                        for ($i = 0; $i < $box_amount; $i++) {
                            ...
                            $response = $this->getNewServerFromVultr($serverData) ;
    ...
    private function askForBoxAddExecute() {
        ...
        $question = 'Add Vultr Cloud Server Boxes?';
