...
class GitCommandAllLinuxMac extends Base {
    ...
    public function checkoutProject(){
        ...
        $this->askForGitCommandTargetRepo();
        $this->doGitCommandCommand();
    ...
    protected function askForGitCommandTargetRepo() {
...
// @todo scrap this
//    protected function doGitCommandCommandWithErrorCheck($params){
//        $data = $this->doGitCommandCommand($params);
//        print $data;
...
//    }
    ...
    protected function doGitCommandCommand() {
