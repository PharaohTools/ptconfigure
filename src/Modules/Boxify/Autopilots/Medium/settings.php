...
$priv_ssh_key_bastion = $priv_ssh_key_git = $priv_ssh_key_jenkins = $priv_ssh_key_secondary_db = $priv_ssh_key_db_balancer =
$priv_ssh_key_web_nodes = $priv_ssh_key_load_balancer = $priv_ssh_key  ;

$provider_bastion = $provider_git = $provider_jenkins = $provider_secondary_db = $provider_db_balancer =
$provider_web_nodes = $provider_load_balancer = $provider ;

$image_id_bastion = $image_id_git = $image_id_jenkins = $image_id_secondary_db = $image_id_db_balancer =
$image_id_web_nodes = $image_id_load_balancer = $image_id ;

$region_id_bastion = $region_id_git = $region_id_jenkins = $region_id_secondary_db = $region_id_db_balancer =
$region_id_web_nodes = $region_id_load_balancer = $region_id ;

$size_id_bastion = $size_id_git = $size_id_jenkins = $size_id_secondary_db = $size_id_db_balancer = $size_id_web_nodes =
$size_id_load_balancer = $size_id ;

$size_id_jenkins = "62" ; // Jenkins is larger as behat was getting memory issues on install

$user_name_bastion = $user_name_git = $user_name_jenkins = $user_name_secondary_db = $user_name_db_balancer = $user_name_web_nodes =
