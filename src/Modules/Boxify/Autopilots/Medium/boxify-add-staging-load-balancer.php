    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                ...
                array ( "Logging" => array( "log" => array( "log-message" => "Lets add the Staging Load Balancer Environment" ),),),
                ...
                array ( "Logging" => array( "log" => array( "log-message" => "Lets add the Staging Load Balancer Box" ),),),
                ...
                array ( "Logging" => array( "log" => array( "log-message" => "Creating medium-staging-load-balancer environment complete"),),),
