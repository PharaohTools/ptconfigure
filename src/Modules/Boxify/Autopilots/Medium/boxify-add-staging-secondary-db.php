...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                // Staging Secondary DB
                array ( "Logging" => array( "log" => array( "log-message" => "Lets add the Staging Secondary DB Environment" ),),),
                ...
                array ( "Logging" => array( "log" => array( "log-message" => "Lets add the Staging Secondary DB Box" ),),),
                ...
                array ( "Logging" => array( "log" => array( "log-message" => "Creating medium-staging-secondary-db environment complete"),),),
