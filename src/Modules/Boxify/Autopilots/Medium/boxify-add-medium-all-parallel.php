        ...
        $this->steps =
            array(
                ...
                array ( "Parallax" => array("cli" => array(
                    ...
                    "command-6"  => "cleopatra autopilot execute --autopilot-file=\"{$parent}boxify-add-staging-db-nodes.php\"",
                    ...
                    "command-10" => "cleopatra autopilot execute --autopilot-file=\"{$parent}boxify-add-production-db-nodes.php\"",
