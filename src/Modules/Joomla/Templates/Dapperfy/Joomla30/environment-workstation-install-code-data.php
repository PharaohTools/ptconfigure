...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
        ...
        // @todo set the vhe-file-ext bassed on if we are on ubuntu 14+, set it to .conf if so
