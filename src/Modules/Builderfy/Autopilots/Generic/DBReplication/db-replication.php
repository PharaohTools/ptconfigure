        ...
        $this->steps =
            array(
                ...
                array ( "Builderfy" => array("continuous-staging-to-production" => array(
                    ...
                    "autopilot-test-invoke-dbinstall-install-file" => "build/config/dapperstrano/autopilots/tiny-staging-invoke-code-data.php",
                    "autopilot-test-invoke-dbconf-install-file" => "build/config/dapperstrano/autopilots/tiny-staging-invoke-code-dbconf.php",
                    "autopilot-prod-invoke-install-file" => "",
                    "autopilot-prod-invoke-dbinstall-install-file" => "build/config/dapperstrano/autopilots/tiny-prod-invoke-code-data.php",
                    "autopilot-prod-invoke-dbconf-install-file" => "build/config/dapperstrano/autopilots/tiny-prod-invoke-code-dbconf.php",
                    "error-email" => "",
