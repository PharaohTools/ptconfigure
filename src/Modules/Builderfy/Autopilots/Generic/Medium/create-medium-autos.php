        ...
        $this->steps =
            array(
                ...
                array ( "Builderfy" => array("continuous-staging-to-production" => array(
                    ...
                    "days-to-keep" => "-1",
                    "amount-to-keep" => "10",
                    "autopilot-test-invoke-install-file" => "build/config/dapperstrano/dapperfy/autopilots/tiny-staging-invoke-code-no-dbconf.php",
                    "autopilot-prod-invoke-install-file" => "build/config/dapperstrano/dapperfy/autopilots/tiny-prod-invoke-code-no-dbconf.php",
                    "error-email" => "",
