        ...
        $this->steps =
            array(
                ...
                array ( "Builderfy" => array("continuous-staging-to-production" => array(
                    ...
                    "days-to-keep" => "-1",
                    "amount-to-keep" => "10",
                    "autopilot-test-invoke-install-file" => "build/config/dapperstrano/dapperfy/autopilots/generated/tiny-staging-invoke-code-no-dbconf.php",
                    "autopilot-test-invoke-dbconf-install-file" => "",
                    "autopilot-test-invoke-dbinstall-install-file" => "",
                    "autopilot-prod-invoke-install-file" => "build/config/dapperstrano/dapperfy/autopilots/generated/tiny-prod-invoke-code-no-dbconf.php",
