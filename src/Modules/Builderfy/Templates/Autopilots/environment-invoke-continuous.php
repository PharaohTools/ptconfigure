...
sudo dapperstrano builderfy continuous --yes --jenkins-home="<%tpl.php%>jenkins-home</%tpl.php%>" --target-job-name="<%tpl.php%>target-job-name</%tpl.php%>" --project-description="This is the Continuous Delivery build for My Project" --primary-scm-url="http://146.185.129.66:8080/git/root/first-pharoah-cd.git" --source-branch-spec="origin/master" --source-scm-url="http://146.185.129.66:8080/git/root/first-pharoah-cd.git" --days-to-keep="<%tpl.php%>days_to_keep</%tpl.php%>" --amount-to-keep="<%tpl.php%>num_to_keep</%tpl.php%>" --autopilot-test-invoke-install-file="<%tpl.php%>autopilot-test-invoke-install-file</%tpl.php%>" --autopilot-prod-invoke-install-file="<%tpl.php%>autopilot-prod-invoke-install-file</%tpl.php%>" --error-email="<%tpl.php%>error-email</%tpl.php%>"
