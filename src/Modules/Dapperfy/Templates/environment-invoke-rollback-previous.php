    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                ...
                array( "log-message" => "Lets begin invoking Rollback to Previous on environment <%tpl.php%>env_name</%tpl.php%>"),
                ) ),
                ...
                array ( "Logging" => array( "log" =>
                array( "log-message" => "Invoking Rollback to Previous on environment <%tpl.php%>env_name</%tpl.php%> complete"),
                ) ),
            );
