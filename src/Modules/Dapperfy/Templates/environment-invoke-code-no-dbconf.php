...
cd dapper$timeDrop
git show HEAD:build/config/dapperstrano/autopilots/****gen_env_name****-install-code-no-dbconf.php > ****gen_env_tmp_dir********gen_env_name****-install-code-no-dbconf.php
rm -rf ****gen_env_tmp_dir****dapper$timeDrop
cd ****gen_env_tmp_dir****
sudo dapperstrano autopilot execute ****gen_env_name****-install-code-no-dbconf.php
sudo chown -R www-data ****dap_proj_cont_dir****current/src
sudo rm ****gen_env_name****-install-code-no-dbconf.php
SSHDATA;
  }
