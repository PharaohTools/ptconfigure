...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
      ...
      R  * ThoughtWorks Go @todo Module ready but check it install doesnt break anything
      R  * Teamcity @todo Module ready but check it install doesnt break anything
         * Jenkins --
         * JenkinsSudo --
         * JenkinsPlugins --
         * Pharoes --
