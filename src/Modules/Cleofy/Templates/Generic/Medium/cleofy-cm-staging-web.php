    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                ...
                array ( "RunCommand" => array("install" => array(
                    "guess" => true,
                    "command" => 'ptconfigure autopilot execute --autopilot-file="build/config/ptconfigure/cleofy/autopilots/generated/medium-staging-web-nodes-invoke-web-node.php"',
                ),),),
                ...
                array ( "RunCommand" => array("install" => array(
                    "guess" => true,
                    "command" => 'ptconfigure autopilot execute --autopilot-file="build/config/ptconfigure/cleofy/autopilots/generated/medium-staging-load-balancer-invoke-web-load-balancer.php"',
                ),),),
