        ...
        $this->steps =
            array(
                ...
                array ( "Parallax" => array("cli" => array(
                    ...
                    "command-4"  => "ptconfigure autopilot execute --autopilot-file=\"{$parent}cleofy-cm-staging-web.php\"",
                    "command-5"  => "ptconfigure autopilot execute --autopilot-file=\"{$parent}cleofy-cm-production-web.php\"",
                ),),),
