...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                ...
                array ( "SFTP" => array( "put" =>  array(
                    "guess" => true,
                    "source" => getcwd()."/build/config/ptconfigure/cleofy/autopilots/generated/<%tpl.php%>env_name</%tpl.php%>-cm-db-load-balancer.php",
    ...
    private function setSSHData() {
        $sshData = <<<"SSHDATA"
cd /tmp
sudo ptconfigure autopilot execute --autopilot-file="/tmp/<%tpl.php%>env_name</%tpl.php%>-cm-db-load-balancer.php"
