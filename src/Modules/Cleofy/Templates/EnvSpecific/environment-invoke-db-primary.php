...
class AutoPilotConfigured extends AutoPilot {
        ...
        $this->steps =
            array(
                ...
                array ( "SFTP" => array( "put" =>  array(
                    "source" => getcwd()."/build/config/cleopatra/cleofy/autopilots/generated/<%tpl.php%>env_name</%tpl.php%>-cm-db-primary.php",
    ...
    private function setSSHData() {
        $sshData = <<<"SSHDATA"
sudo cleopatra autopilot execute --autopilot-file="/tmp/<%tpl.php%>env_name</%tpl.php%>-cm-db-primary.php"
rm /tmp/<%tpl.php%>env_name</%tpl.php%>-cm-db-primary.php
SSHDATA;
        return $sshData ;
    }
