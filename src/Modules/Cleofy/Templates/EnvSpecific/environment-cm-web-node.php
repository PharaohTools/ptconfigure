...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                array ( "Logging" => array( "log" => array( "log-message" => "Lets begin Configuration of a Web Node on environment <%tpl.php%>env_name</%tpl.php%>"),),),
...
//                    array("user-name" => "{$this->myUser}"),),),
                ...
                array ( "Logging" => array( "log" => array( "log-message" => "Configuring a Web Node on environment <%tpl.php%>env_name</%tpl.php%> complete"),),),
