...
class LinuxCompiler extends Base {
    ...
    public function execute($pageVars) {
        ...
        if ($action=="archive") {
            $this->content["result"] = $thisModel->askWhetherToInstallFromArchive();
            return array ("type"=>"view", "view"=>"invoke", "pageVars"=>$this->content); }

        if ($action=="directory") {
            $this->content["result"] = $thisModel->askWhetherToInstallFromDirectory();
            return array ("type"=>"view", "view"=>"invoke", "pageVars"=>$this->content); }
