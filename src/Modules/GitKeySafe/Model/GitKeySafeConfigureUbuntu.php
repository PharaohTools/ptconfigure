...
class GitKeySafeConfigureUbuntu extends BaseTemplater {
    ...
    public function __construct($params) {
        ...
        $this->targetLocation = "/etc/gitkeysafe/gitkeysafe.cfg" ;
        $this->initialize();
    }
    ...
    protected function setDefaultReplacements() {
        ...
        $this->replacements = array(
            ...
            "global_maxconn" => "2000",
            "global_user" => "gitkeysafe",
            "global_group" => "gitkeysafe",
            "defaults_log" => "global",
            "defaults_mode" => "http",
            ...
            "listen_stats_uri_string" => "stats uri /gitkeysafe?stats",
    ...
    protected function setTemplateFile() {
        ...
        $this->templateFile .= DIRECTORY_SEPARATOR."gitkeysafe.cfg" ;
    }
