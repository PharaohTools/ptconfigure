...
class AWSEC2OverwriteNew extends BaseAWSEC2AllOS {
    ...
    public function performAWSEC2OverwriteNew($params=null){
        ...
        foreach ($environments as $environment) {
            ...
            $question = 'Overwrite current server details for '.$envName.' with new AWS EC2 Servers?';
            ...
            if ($overwriteThisEnvironment == true) {
                ...
                foreach ($environment["servers"] as $server) {
                    ...
                    $newAWSEC2Server = $this->getNewServerFromAWSEC2($serverData) ;
                    $sCount++; } } }
    ...
    private function askForOverwriteExecute(){
        ...
        $question = 'Overwrite current server details with new AWS EC2 Servers?';
