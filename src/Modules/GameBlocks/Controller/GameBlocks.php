...
class GameBlocks extends Base {
    ...
    public function execute($pageVars) {
        ...
        if ($action=="box-add") {
            ...
            $isDefaultAction = self::checkDefaultActions($pageVars, array(), $thisModel) ;
            if ( is_array($isDefaultAction) ) { return $isDefaultAction; }
            $this->content["gameBlocksResult"] = $thisModel->addBox();
            return array ("type"=>"view", "view"=>"gameBlocksAPI", "pageVars"=>$this->content); }
        ...
        if ($action=="box-remove") {
            ...
            $isDefaultAction = self::checkDefaultActions($pageVars, array(), $thisModel) ;
            if ( is_array($isDefaultAction) ) { return $isDefaultAction; }
            $this->content["gameBlocksResult"] = $thisModel->askWhetherToSaveOverwriteCurrent();
            return array ("type"=>"view", "view"=>"gameBlocksAPI", "pageVars"=>$this->content); }
        ...
        if ($action=="box-destroy") {
            ...
            $isDefaultAction = self::checkDefaultActions($pageVars, array(), $thisModel) ;
            if ( is_array($isDefaultAction) ) { return $isDefaultAction; }
            $this->content["gameBlocksResult"] = $thisModel->destroyBox();
            return array ("type"=>"view", "view"=>"gameBlocksAPI", "pageVars"=>$this->content); }
        ...
        if ($action=="box-destroy-all") {
            ...
            $isDefaultAction = self::checkDefaultActions($pageVars, array(), $thisModel) ;
            if ( is_array($isDefaultAction) ) { return $isDefaultAction; }
            $this->content["gameBlocksResult"] = $thisModel->destroyAllBoxes();
            return array ("type"=>"view", "view"=>"gameBlocksAPI", "pageVars"=>$this->content); }
        ...
        if ($action=="save-ssh-key") {
            ...
            $isDefaultAction = self::checkDefaultActions($pageVars, array(), $thisModel) ;
            if ( is_array($isDefaultAction) ) { return $isDefaultAction; }
            $this->content["gameBlocksResult"] = $thisModel->askWhetherToSaveSshKey();
            return array ("type"=>"view", "view"=>"gameBlocksAPI", "pageVars"=>$this->content); }
        ...
        if ($action=="list") {
            ...
            $isDefaultAction = self::checkDefaultActions($pageVars, array(), $thisModel) ;
            if ( is_array($isDefaultAction) ) { return $isDefaultAction; }
            $this->content["gameBlocksResult"] = $thisModel->askWhetherToListData();
            return array ("type"=>"view", "view"=>"gameBlocksList", "pageVars"=>$this->content); }

        $this->content["messages"][] = "Invalid Game Blocks Action";
